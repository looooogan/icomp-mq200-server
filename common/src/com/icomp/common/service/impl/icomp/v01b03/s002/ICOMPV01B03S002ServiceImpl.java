package com.icomp.common.service.impl.icomp.v01b03.s002;
 ...
 */
public class ICOMPV01B03S002ServiceImpl extends BaseService implements ICOMPV01B03S002Service {
    ...
    public Map<String, Object> getList(Outsidefactory entity) {
        ...
        try {
            ...
            List<Outsidefactory> list =  outsidefactoryDao.searchByList(entity);
            // 2017/08/25 王冉 变更↑↑↑　dazhong@YMSC
            ...
            if (list.size() <= 0) {
                ...
                int total = 0;
                if(entity.getGroupString().equals("outsideFactoryID")){
                    total = outsidefactoryDao.searchByCount(entity);
                }else{
                    total = outsidefactoryDao.searchByPrimaryViewCount(entity);
                }
    ...
    public Map<String, Object> getOutList(Outsidefactory entity){
        ...
        Map<String, Object> rtn = new HashMap<String, Object>();
        try {
            List<Outsidefactory> list = (List<Outsidefactory>) outsidefactoryDao.searchByPrimaryView(entity);
