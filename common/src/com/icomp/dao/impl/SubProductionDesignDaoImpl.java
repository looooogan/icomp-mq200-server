...
public class SubProductionDesignDaoImpl implements SubProductionDesignDao{
	...
	@Override
	public List<SubProductionDesign> searchByList(BaseEntity entity) throws SQLException {
		// 按任意查询
		return (List<SubProductionDesign>)dataSource.queryForList("SubProductionDesign.searchByList", entity);
	}
