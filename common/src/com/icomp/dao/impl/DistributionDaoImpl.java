...
public class DistributionDaoImpl implements DistributionDao {
	...
	public int searchByCount(BaseEntity entity) throws SQLException {
		// 查询数据条数
		return (Integer)dataSource.queryForObject("Distribution.searchByCount", entity);
	}
	...
	public List<Distribution> searchByList(BaseEntity entity) throws SQLException {
		// 按任意查询
		return (List<Distribution>)dataSource.queryForList("Distribution.searchByList", entity);
	}
	@Override
