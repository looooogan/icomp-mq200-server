 ...
 * 更新者  ：taoyy
 */
public class ToolReplaceDaoImpl implements ToolReplaceDao{
	...
	public int delete(BaseEntity entity) throws SQLException {
		// 数据删除
		return dataSource.delete("ToolReplace.delete", entity);
	}
	...
	public Object insert(BaseEntity entity) throws SQLException {
		// 数据插入
		return dataSource.insert("ToolReplace.insert", entity);
	}
	...
	public int insertBatch(List<? extends BaseEntity> list) throws SQLException {
		...
		try{
			for(Tool entity : (List<Tool>)list){
				//数据批量插入
				Object obj = dataSource.insert("ToolReplace.insert", entity);
				listObject.add(obj);
			}
			//提交事务
	...
	public int searchByCount(BaseEntity entity) throws SQLException {
		// 查询数据条数
		return (Integer)dataSource.queryForObject("ToolReplace.searchByCount", entity);
	}
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<ToolReplace> searchByList(BaseEntity entity) throws SQLException {
		// 按任意查询
		return (List<ToolReplace>)dataSource.queryForList("ToolReplace.searchByList", entity);
	}
	 ...
	 */
	@Override
	public ToolReplace searchByPrimaryKey(BaseEntity entity) throws SQLException {
		// 按任意查询
		return (ToolReplace)dataSource.queryForObject("ToolReplace.searchByPrimaryKey", entity);
	}
	...
	public int update(BaseEntity entity) throws SQLException {
		// 数据更新(未指定数据更新为null)
		return dataSource.update("ToolReplace.update", entity);
	}
	...
	public int updateBatch(List<? extends BaseEntity> list) throws SQLException {
		...
		try{
			for(Tool entity : (List<Tool>)list){
				//数据批量更新(未指定数据更新为null)
				Object obj = dataSource.update("ToolReplace.update", entity);
				listObject.add(obj);
			}
			//提交事务
			dataSource.commitTransaction();
	...
	public int updateNonQuery(BaseEntity entity) throws SQLException {
		// 数据更新(未指定数据不更新)
		return dataSource.update("ToolReplace.updateNonQuery", entity);
	}
	...
	public int updateNonQueryBatch(List<? extends BaseEntity> list) throws SQLException {
		...
		try{
			for(Tool entity : (List<Tool>)list){
				//数据批量更新(未指定数据不更新)
				Object obj = dataSource.update("ToolReplace.updateNonQuery", entity);
				listObject.add(obj);
			}
			//提交事务
			dataSource.commitTransaction();
