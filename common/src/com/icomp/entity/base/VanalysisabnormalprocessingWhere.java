 ...
 * 
 */
public class VanalysisabnormalprocessingWhere extends BaseEntity implements Serializable {
	...
	/* 	*/ 
	private BigDecimal actualProcessingVolumeWhere;

	/**
	 * 取得
	 * @return actualProcessingVolumeWhere
	 */
	public BigDecimal getActualProcessingVolumeWhere () {
		return actualProcessingVolumeWhere;
	}

	/**
	 * 设定
	 * @param actualProcessingVolumeWhere
	 */
	public void setActualProcessingVolumeWhere (BigDecimal actualProcessingVolumeWhere) {
		this.actualProcessingVolumeWhere = actualProcessingVolumeWhere;
	}
}
