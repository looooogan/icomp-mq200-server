 ...
 * 
 */
public class VwarningWhere extends BaseEntity implements Serializable {
	...
	/* 姓名	*/ 
	private String warningNameWhere;

	/**
	 * 姓名取得
	 * @return warningNameWhere
	 */
	public String getWarningNameWhere () {
		return warningNameWhere;
	}

	/**
	 * 姓名设定
	 * @param warningNameWhere
	 */
	public void setWarningNameWhere (String warningNameWhere) {
		this.warningNameWhere = warningNameWhere;
	}
