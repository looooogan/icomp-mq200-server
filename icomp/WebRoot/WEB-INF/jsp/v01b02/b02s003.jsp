...
<html>
		...
		<script type="text/javascript">
			$(function(){
				...
				column:[{
						...
						format:function(r){
							return '<span class="ui-grid-tdtx">'+fdate(r.receiveTime)+'</span>';
                        }
					},{
			...
			*/
			function search(){
				var param = {
					opt:'list',
					RedemptionAppliedID:$(redemptionForm.RedemptionAppliedID).val(),
					ReceiveUser:$(redemptionForm.ReceiveUser).val(),
					DateStar:$(redemptionForm.dstar).val(),
					DateEnd:$(redemptionForm.dend).val(),
				}
				$('#list').grid('url','B02S003.action');
	...
	<body>
		...
		<div class="ui-layout-north g-ct-tt">
			<div class="g-ct-ttc">
				<span>${sessionScope.lang.b02s003pageTitle}</span>
		...
		<div class="ui-layout-center g-ct-bd">
			<div class="ui-layout-north">
				...
				<form id="redemptionForm" name="redemptionForm" method="post">
					<table width="100%" class="m-frmtb">
						<tr>
							...
							<th width="150">
								${sessionScope.lang.ReceiveUserText}
							</th>
							<td>
								<input name="ReceiveUser" type="text" class="u-ipt" maxlength="36">
							</td>
							<th width="150">
								${sessionScope.lang.ReceiveTimeText}
							</th>
