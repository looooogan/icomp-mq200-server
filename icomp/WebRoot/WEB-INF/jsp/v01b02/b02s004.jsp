...
<html>
		...
		<script type="text/javascript">
			...
			*/
			function search(){
				var param = {
					opt:'list',
					SynthesisParametersCode:$(toolsettingForm.SynthesisParametersCode).val(),
					DateStar:$(toolsettingForm.dstar).val(),
					DateEnd:$(toolsettingForm.dend).val(),
				}
				$('#list').grid('url','B02S004.action');
	...
	<body>
		...
		<div class="ui-layout-north g-ct-tt">
			<div class="g-ct-ttc">
				<span>${sessionScope.lang.b02s004pageTitle}</span>
		...
		<div class="ui-layout-center g-ct-bd">
			<div class="ui-layout-north">
				...
				<form id="toolsettingForm" name="toolsettingForm" method="post">
					<table width="100%" class="m-frmtb">
						<tr>
							...
							<td>
								<input name="SynthesisParametersCode" type="text" class="u-ipt" maxlength="36">
							</td>
							<th width="150">
