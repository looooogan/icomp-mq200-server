package com.icomp.v01b09.b09s007.business;
 ...
 */
public interface B09S007Business {
	/**
	 * 修复通知单查询列表
	 * @title getList
	 * @param param
	...
	Map<String,Object> outFactoryAdd(Map<String, Object> param, String customerId, String langCode, String langValue)throws BusinessException;
	// 2017/09/12 宋健 变更↑↑↑　dazhong@YMSC
	/**
	 *  新建厂外商家
	 * @param param
	...
	Map<String,Object> outFactoryEdit(Map<String, Object> param, String langCode, String langValue,String userID)throws BusinessException;
	Map<String,Object> outFactoryEdit2(Map<String, Object> param, String langCode, String langValue,String userID)throws BusinessException,ParseException;
	...
	Map<String,Object> outFactoryDel(Map<String, Object> param, String langCode, String langValue,String userID)throws BusinessException;
	// 2017/09/13 宋健 追加↑↑↑　dazhong@YMSC
}
